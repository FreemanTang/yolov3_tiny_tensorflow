# coding: utf-8
'''
camera:python camera_or_video_test_yolov3_tiny.py --input_video 0
video:python camera_or_video_test_yolov3_tiny.py --input_video videos/test_video.mp4
'''
...
def gstreamer_pipeline(
    capture_width=720, #摄像头预捕获的图像宽度
    capture_height=480, #摄像头预捕获的图像高度
    display_width=720, #窗口显示的图像宽度
